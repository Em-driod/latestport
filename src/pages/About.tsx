  ...
  return (
    <Container>
      <article className="fade-up elite-bio" style={{ display: 'grid', gap: '2rem', maxWidth: '700px', margin: '0 auto' }}>
        <h2 className="h2 text-4xl font-extrabold text-green-400 mb-2">About Me</h2>
        ...
        <div className="card bg-neutral-900 border border-green-400/30 rounded-xl p-6 shadow-lg">
          <h3 className="text-xl font-semibold text-green-300 mb-3">Elite Skillset</h3>
        ...
        <div className="elite-values bg-neutral-800 rounded-xl p-5 mt-4">
          <h4 className="text-lg font-bold text-green-400 mb-2">Values</h4>
        ...
        <p className="mt-6 text-neutral-400 text-base text-center">
          <span className="font-semibold text-green-400">Ready to elevate your next project?</span> Let's connect and build something extraordinary.
        </p>
      </article>
    </Container>
  )
